...
namespace PCBrouter_prj.Model
{
    ...
    public partial class PCBrouterDBfinalEntities : DbContext
    {
        public PCBrouterDBfinalEntities()
           ...
           //: base(@"metadata = res://*/Model.Model1.csdl|res://*/Model.Model1.ssdl|res://*/Model.Model1.msl;provider=System.Data.SqlClient;provider connection string=';data source=DESKTOP-FPLJSMH\KSTDATABASE;initial catalog=PCBrouterDBfinal;user id=sa;password=13011408Bn;MultipleActiveResultSets=True';")
        {
        }
